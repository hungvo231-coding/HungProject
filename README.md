...
//    Constructor of product used to initialize these attributes and run automatically when the object is created to print a message "Product have been created!" whenever the object is created.
//    Destruction run automactically when the main end which print "
